  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Tu Tu Ngar — Shared Rides in Yangon" },
      {
        ...
        content: "Pre-booked shared transportation across Yangon.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Noto+Sans+Myanmar:wght@400;500;700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
